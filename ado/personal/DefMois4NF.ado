...
/* Programme de calcul de périodes de 4 semaines  (23/06/06 V)  */
/*Remplace DefMois4New. Avant, Mois4 était créée à partir de sm91, maintenant à partir de pa (période d'achat allant de 1 à 13)*/
/*utilisable de 1998 à 2003 sur les données ancienne et nouvelle formules*/
/*utilisable sur 2004 (2/05/07) (V)*/
/*8/08/08 nummois renommé NumMois et labellisé*/
...
tostring pa, gen (pa2)
/*création numéro du mois de l'achat*/
...
*replace Mois4 = NumMois + (an - 1998) * 13 if dtwa<20020128  /*année 1998 de référence*/
*replace Mois4= int(Week2002/4)+ 54 if dtwa>= 20020128  /* On "calle" notre numéro de mois sur les anciennes valeurs de Mois4 */ 
...
label variable NumMois "Numéro du Mois (de 1 à 13)"
