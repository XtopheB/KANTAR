*! outtable 1.0.3   cfb 2227  for Petia
...
* Version de Outttable ancienne et qui tourne sous Stata8 SE CB le 9/02/04
*

program define outtable1,rclass
version 7.0
...
file write `hh' " \" "\ `hl'\hline \hline " _n 
local jlim `nc1'
local klim `nc'
forv i=1/`nr' {
...
file write `hh' "\hline\hline \end{tabular}" _n
*if "`key'" ~= "" {
